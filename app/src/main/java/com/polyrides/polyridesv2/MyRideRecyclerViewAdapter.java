...
import com.polyrides.polyridesv2.RidesFragment.OnListFragmentInteractionListener;
...
public class MyRideRecyclerViewAdapter extends RecyclerView.Adapter<MyRideRecyclerViewAdapter.ViewHolder> {
    ...
    public MyRideRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
