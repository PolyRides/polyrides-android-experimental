...
public class AddRideOfferActivity extends AppCompatActivity implements AddRides_1.OnFragmentInteractionListener,
        AddRides_2.OnFragmentInteractionListener,
        AddRides_3.OnFragmentInteractionListener,
        AddRides_4.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment f = AddRides_1.newInstance("","");
